...
export const OrderDrawerShow = () => {
  ...
  const breakppoint = Grid.useBreakpoint();
  return (
    <>
      {contextHolder}
      ...
      <Row gutter={24}>
        <Col xs={24} sm={24} md={12} lg={12} xl={12}>
          ...
          >
            <Flex gap={24} vertical={!breakppoint?.sm || !breakppoint?.md || !breakppoint?.lg}>
              <Image
                width={240}
                height={240}
                style={{
                ...
                >
                  <Flex vertical gap={12}>
                    ...
                    <Flex align="baseline" gap={8}>
                      ...
                      <Typography.Text>
                        {packagingTypes?.find((type) => type.id === order?.packaging_type_id)
                          ?.name || "N/A"}
                      </Typography.Text>
                    </Flex>
